...
(function ($) {
    ...
    $.ajaxComboBox = function (area_pack, source, options, msg) {
        ...
        function individual(area_combobox) {
            ...
            // added by Michael Buen...
            // var theTextHeight = 25; // I don't know yet how to get the textbox's height
            var theTextHeight = 25;
            // alert(theTextHeight.toString());
            var theTop = $(area_pack).offset().top + theTextHeight - $(window).scrollTop();
            var theLeft = $(area_pack).offset().left - $(window).scrollLeft();
            // ...added
            ...
            // style added by Michael Buen. To make the list portion visible in divs, especially grids
            var $result_area = $('<div style="position: fixed; z-index: 2; left: ' + theLeft + 'px; top: ' + theTop + 'px"></div>')
                .addClass(options.re_area_class); var $navi = $('<div></div>')
