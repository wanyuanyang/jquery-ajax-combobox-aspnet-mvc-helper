...
(function ($) {
    ...
    $.ajaxComboBox = function (area_pack, source, options, msg) {
        ...
        /*
        var theName = $(area_pack).attr('id').replace(/_/g, '.');
        var theInput = 'input[name=' + theName.replace(/\./g, '\\.') + ']';
        var isExisting = $(theInput).length == 1;       
        ...
        */
        ...
        function individual(area_combobox) {
            ...
            $result_area.css("z-index", 100);

            var $navi = $('<div></div>')
				.addClass(options.navi_class);

            // $('#myGrid').css('z-index', 1);
            ...
            function setInitVal() {
                ...
                if (options.select_only) {
                    ...
                    //テキストボックスへ値を挿入
                    var init_val_data = '';
                    // var $xhr2 = $.get( // removed by Michael Buen
                    var $xhr2 = $.post( // added by Michael Buen
						options.init_src,
						{
            ...
            function displayItems(arr_candidate, arr_attached, arr_primary_key) {
                ...
                var theTextHeight = $(area_pack).height();
                // theTextHeight = 24;
                // alert(theTextHeight);
    ...
    $.fn.ajaxComboBox = function (source, options) {
        ...
        options = $.extend({
            ...
            img_dir: '/Scripts/Ienablemuch.Scripts/Ienablemuch.JqueryAjaxComboBox/img/',             //ボタン画像へのパス // added by Michael Buen
        ...
        options = $.extend({
            ...
            //パッケージ
            packagex: false,                            //パッケージとして表示するかどうか？
